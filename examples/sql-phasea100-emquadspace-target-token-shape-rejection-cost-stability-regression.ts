...
async function main() {
  ...
  // em-quad-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // em-quad-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea100-emquadspace-target-token-shape-rejection-cost-stability-regression ok");
}
