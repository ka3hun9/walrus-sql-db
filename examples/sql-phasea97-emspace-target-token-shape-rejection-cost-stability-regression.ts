...
async function main() {
  ...
  // em-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // em-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea97-emspace-target-token-shape-rejection-cost-stability-regression ok");
}
