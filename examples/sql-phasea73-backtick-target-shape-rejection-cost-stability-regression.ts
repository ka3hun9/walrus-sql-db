...
async function main() {
  ...
  // backtick-quoted targets in join-aware UPDATE currently reject deterministically as unsupported shape
  await expectErr(
  ...
  // backtick-quoted multi-target DELETE should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea73-backtick-target-shape-rejection-cost-stability-regression ok");
}
