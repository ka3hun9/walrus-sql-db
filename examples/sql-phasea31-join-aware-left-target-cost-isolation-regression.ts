...
async function main() {
  ...
  // join-aware DML targets left table only; right-table constraint cost must stay untouched
  ...
  console.log("sql-phasea31-join-aware-left-target-cost-isolation-regression ok");
}
