...
async function main() {
  ...
  // zero-width-non-joiner target tokens normalize and reject deterministically
  await expectErr(
  ...
  // zero-width-non-joiner multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea104-zwnj-target-token-shape-rejection-cost-stability-regression ok");
}
