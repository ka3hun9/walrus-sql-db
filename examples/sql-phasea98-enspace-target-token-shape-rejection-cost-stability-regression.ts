...
async function main() {
  ...
  // en-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // en-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea98-enspace-target-token-shape-rejection-cost-stability-regression ok");
}
