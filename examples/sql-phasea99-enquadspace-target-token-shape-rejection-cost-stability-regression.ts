...
async function main() {
  ...
  // en-quad-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // en-quad-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea99-enquadspace-target-token-shape-rejection-cost-stability-regression ok");
}
