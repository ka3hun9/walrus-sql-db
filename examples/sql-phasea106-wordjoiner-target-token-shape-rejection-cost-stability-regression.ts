...
async function main() {
  ...
  // word-joiner target tokens normalize and reject deterministically
  await expectErr(
  ...
  // word-joiner multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea106-wordjoiner-target-token-shape-rejection-cost-stability-regression ok");
}
