...
const cases: RunnerCase[] = [
  ...
  { name: "phasea76-singlequote-target-shape-rejection-cost-stability", script: "examples/sql-phasea76-singlequote-target-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea77-spaced-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea77-spaced-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea78-newline-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea78-newline-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea79-tab-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea79-tab-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea80-cr-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea80-cr-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea81-crlf-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea81-crlf-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea82-ff-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea82-ff-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea83-vtab-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea83-vtab-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea84-mixedws-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea84-mixedws-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea85-multispace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea85-multispace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea86-nbsp-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea86-nbsp-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea87-thinspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea87-thinspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea88-nnbsp-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea88-nnbsp-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea89-hairspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea89-hairspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea90-figurespace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea90-figurespace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea91-ideospace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea91-ideospace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea92-mmathspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea92-mmathspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea93-punctspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea93-punctspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea94-sixperemspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea94-sixperemspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea95-threeperemspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea95-threeperemspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea96-fourperemspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea96-fourperemspace-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea97-emspace-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea97-emspace-target-token-shape-rejection-cost-stability-regression.ts" },
  ...
  { name: "phasea102-mvs-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea102-mvs-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea103-zwsp-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea103-zwsp-target-token-shape-rejection-cost-stability-regression.ts" },
  { name: "phasea104-zwnj-target-token-shape-rejection-cost-stability", script: "examples/sql-phasea104-zwnj-target-token-shape-rejection-cost-stability-regression.ts" },
];
