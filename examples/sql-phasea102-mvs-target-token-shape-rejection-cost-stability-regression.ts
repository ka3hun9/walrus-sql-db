...
async function main() {
  ...
  // mongolian-vowel-separator target tokens normalize and reject deterministically
  await expectErr(
  ...
  // mongolian-vowel-separator multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea102-mvs-target-token-shape-rejection-cost-stability-regression ok");
}
