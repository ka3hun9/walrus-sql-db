...
async function main() {
  ...
  // repeated-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // repeated-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea85-multispace-target-token-shape-rejection-cost-stability-regression ok");
}
