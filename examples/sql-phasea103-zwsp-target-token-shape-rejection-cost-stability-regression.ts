...
async function main() {
  ...
  // zero-width-space target tokens normalize and reject deterministically
  await expectErr(
  ...
  // zero-width-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea103-zwsp-target-token-shape-rejection-cost-stability-regression ok");
}
