...
async function main() {
  ...
  // zero-width-joiner target tokens normalize and reject deterministically
  await expectErr(
  ...
  // zero-width-joiner multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea105-zwj-target-token-shape-rejection-cost-stability-regression ok");
}
