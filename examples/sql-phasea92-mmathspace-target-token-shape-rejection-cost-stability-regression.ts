...
async function main() {
  ...
  // medium-mathematical-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // medium-mathematical-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea92-mmathspace-target-token-shape-rejection-cost-stability-regression ok");
}
