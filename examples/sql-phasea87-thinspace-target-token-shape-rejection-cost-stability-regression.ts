...
async function main() {
  ...
  // thin-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // thin-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea87-thinspace-target-token-shape-rejection-cost-stability-regression ok");
}
