...
async function main() {
  ...
  // ideographic-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // ideographic-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea91-ideospace-target-token-shape-rejection-cost-stability-regression ok");
}
