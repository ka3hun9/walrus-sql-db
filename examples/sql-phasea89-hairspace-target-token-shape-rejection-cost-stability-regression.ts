...
async function main() {
  ...
  // hair-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // hair-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea89-hairspace-target-token-shape-rejection-cost-stability-regression ok");
}
