...
async function main() {
  ...
  // figure-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // figure-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea90-figurespace-target-token-shape-rejection-cost-stability-regression ok");
}
