...
async function main() {
  ...
  // bracket-quoted targets in join-aware UPDATE currently reject deterministically as unsupported shape
  await expectErr(
  ...
  // bracket-quoted multi-target DELETE should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea75-bracket-target-shape-rejection-cost-stability-regression ok");
}
