...
async function main() {
  ...
  // ogham-space-mark target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // ogham-space-mark multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea101-oghamspace-target-token-shape-rejection-cost-stability-regression ok");
}
