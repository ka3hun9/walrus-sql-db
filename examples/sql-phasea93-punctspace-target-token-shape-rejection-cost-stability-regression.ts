...
async function main() {
  ...
  // punctuation-space target tokens normalize to spaced token shape and reject deterministically
  await expectErr(
  ...
  // punctuation-space multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea93-punctspace-target-token-shape-rejection-cost-stability-regression ok");
}
