...
async function main() {
  ...
  // bom target tokens normalize and reject deterministically
  await expectErr(
  ...
  // bom multi-target DELETE list should reject deterministically
  await expectErr(
  ...
  console.log("sql-phasea107-bom-target-token-shape-rejection-cost-stability-regression ok");
}
